...
func TearDown(clients *test.Clients, cleaner *test.Cleaner, logf logging.FormatLogger) {
	cleaner.Clean(true)
}
...
func CreateChannel(clients *test.Clients, channel *v1alpha1.Channel, logf logging.FormatLogger, cleaner *test.Cleaner) error {
...
func CreateSubscription(clients *test.Clients, sub *v1alpha1.Subscription, logf logging.FormatLogger, cleaner *test.Cleaner) error {
...
func CreateServiceAccount(clients *test.Clients, sa *corev1.ServiceAccount, logf logging.FormatLogger, cleaner *test.Cleaner) error {
...
func CreateClusterRoleBinding(clients *test.Clients, crb *rbacv1.ClusterRoleBinding, logf logging.FormatLogger, cleaner *test.Cleaner) error {
...
func CreateService(clients *test.Clients, svc *corev1.Service, logf logging.FormatLogger, cleaner *test.Cleaner) error {
...
func CreatePod(clients *test.Clients, pod *corev1.Pod, logf logging.FormatLogger, cleaner *test.Cleaner) error {
...
func WaitForAllPodsRunning(clients *test.Clients, logf logging.FormatLogger, namespace string) error {
