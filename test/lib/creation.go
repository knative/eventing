...
func (c *Client) CreateChannelOrFail(name string, channelTypeMeta *metav1.TypeMeta) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		var e error
		gvr, e = c.Duck.CreateGenericChannelObject(metaResource)
		if e != nil {
...
func (c *Client) CreateChannelWithDefaultOrFail(channel *messagingv1.Channel) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := channels.Create(c.Ctx, channel, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreateSubscriptionOrFail(
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		...
		var e error
		retSubscription, e = subscriptions.Create(c.Ctx, subscription, metav1.CreateOptions{})
		if e != nil {
	...
	if err != nil && errors.IsAlreadyExists(err) {
		err = c.RetryWebhookErrors(func(attempts int) (err error) {
			...
			// update subscription with the new reference
			var e error
			retSubscription, e = subscriptions.Get(c.Ctx, name, metav1.GetOptions{})
			if e != nil {
				c.T.Logf("Failed to create subscription %q: %v", name, e)
			}
			return e
...
func (c *Client) CreateConfigMapOrFail(name, namespace string, data map[string]string) *corev1.ConfigMap {
	...
	configMap, err := c.Kube.CoreV1().ConfigMaps(namespace).Create(c.Ctx, resources.ConfigMap(name, namespace, data), metav1.CreateOptions{})
	if err != nil {
...
`, channel.APIVersion, channel.Kind),
	...
	_, err := c.Kube.CoreV1().ConfigMaps(c.Namespace).Create(c.Ctx, cm, metav1.CreateOptions{})
	if err != nil {
...
func (c *Client) CreateBrokerOrFail(name string, options ...resources.BrokerOption) *eventingv1.Broker {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		...
		var e error
		retBroker, e = brokers.Create(c.Ctx, broker, metav1.CreateOptions{})
		if e != nil {
	...
	if err != nil && errors.IsAlreadyExists(err) {
		err := c.RetryWebhookErrors(func(attempts int) (err error) {
			...
			// update broker with the new reference
			var e error
			retBroker, e = brokers.Get(c.Ctx, name, metav1.GetOptions{})
			if e != nil {
...
func (c *Client) CreateTriggerOrFail(name string, options ...resources.TriggerOption) *eventingv1.Trigger {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		...
		var e error
		retTrigger, e = triggers.Create(c.Ctx, trigger, metav1.CreateOptions{})
		if e != nil {
	...
	if err != nil && !errors.IsAlreadyExists(err) {
		err = c.RetryWebhookErrors(func(attempts int) (err error) {
			...
			// update trigger with the new reference
			var e error
			retTrigger, e = triggers.Get(c.Ctx, name, metav1.GetOptions{})
			if e != nil {
...
func (c *Client) CreateFlowsSequenceOrFail(sequence *flowsv1.Sequence) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := sequences.Create(c.Ctx, sequence, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreateFlowsParallelOrFail(parallel *flowsv1.Parallel) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := parallels.Create(c.Ctx, parallel, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreateSinkBindingV1Beta1OrFail(sb *sourcesv1beta1.SinkBinding) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := sbInterface.Create(c.Ctx, sb, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreateApiServerSourceV1Beta1OrFail(apiServerSource *sourcesv1beta1.ApiServerSource) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := apiServerInterface.Create(c.Ctx, apiServerSource, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreateContainerSourceV1Beta1OrFail(containerSource *sourcesv1beta1.ContainerSource) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := containerInterface.Create(c.Ctx, containerSource, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreatePingSourceV1Beta1OrFail(pingSource *sourcesv1beta1.PingSource) {
	...
	err := c.RetryWebhookErrors(func(attempts int) (err error) {
		_, e := pingInterface.Create(c.Ctx, pingSource, metav1.CreateOptions{})
		if e != nil {
...
func (c *Client) CreateServiceOrFail(svc *corev1.Service) *corev1.Service {
	...
	namespace := c.Namespace
	if newSvc, err := c.Kube.CoreV1().Services(namespace).Create(c.Ctx, svc, metav1.CreateOptions{}); err != nil {
...
func WithService(name string) func(*corev1.Pod, *Client) error {
	return func(pod *corev1.Pod, client *Client) error {
		...
		if _, err := svcs.Create(client.Ctx, svc, metav1.CreateOptions{}); err != nil {
			return err
		}
...
func (c *Client) CreatePodOrFail(pod *corev1.Pod, options ...func(*corev1.Pod, *Client) error) {
	...
	err := reconciler.RetryErrors(func(attempts int) (err error) {
		...
		_, e := c.Kube.CreatePod(c.Ctx, pod)
		return e
...
func (c *Client) CreateDeploymentOrFail(deploy *appsv1.Deployment, options ...func(*appsv1.Deployment, *Client) error) {
	...
	if _, err := c.Kube.AppsV1().Deployments(deploy.Namespace).Create(c.Ctx, deploy, metav1.CreateOptions{}); err != nil {
...
func (c *Client) CreateCronJobOrFail(cronjob *batchv1beta1.CronJob, options ...func(*batchv1beta1.CronJob, *Client) error) {
	...
	if _, err := c.Kube.BatchV1beta1().CronJobs(cronjob.Namespace).Create(c.Ctx, cronjob, metav1.CreateOptions{}); err != nil {
...
func (c *Client) CreateServiceAccountOrFail(saName string) {
	...
	if _, err := sas.Create(c.Ctx, sa, metav1.CreateOptions{}); err != nil {
...
func (c *Client) CreateClusterRoleOrFail(cr *rbacv1.ClusterRole) {
	...
	if _, err := crs.Create(c.Ctx, cr, metav1.CreateOptions{}); err != nil && !errors.IsAlreadyExists(err) {
...
func (c *Client) CreateRoleOrFail(r *rbacv1.Role) {
	...
	if _, err := rs.Create(c.Ctx, r, metav1.CreateOptions{}); err != nil && !errors.IsAlreadyExists(err) {
...
func (c *Client) CreateRoleBindingOrFail(saName, rKind, rName, rbName, rbNamespace string) {
	...
	if _, err := rbs.Create(c.Ctx, rb, metav1.CreateOptions{}); err != nil && !errors.IsAlreadyExists(err) {
...
func (c *Client) CreateClusterRoleBindingOrFail(saName, crName, crbName string) {
	...
	if _, err := crbs.Create(c.Ctx, crb, metav1.CreateOptions{}); err != nil && !errors.IsAlreadyExists(err) {
