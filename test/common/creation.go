...
func (client *Client) CreateClusterRoleBindingOrFail(saName, crName, crbNamespace string) {
	saNamespace := client.Namespace
	crb := resources.ClusterRoleBinding(saName, saNamespace, crName, crbNamespace)
