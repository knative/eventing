...
func newVirtualService(channel *eventingv1alpha1.Channel, svc *corev1.Service) *istiov1alpha3.VirtualService {
	destinationHost := reconciler.ServiceHostName(channelDispatcherServiceName(channel.Spec.Provisioner.Name), system.Namespace)
	return &istiov1alpha3.VirtualService{
		...
		Spec: istiov1alpha3.VirtualServiceSpec{
			Hosts: []string{
				reconciler.ServiceHostName(svc.Name, channel.Namespace),
