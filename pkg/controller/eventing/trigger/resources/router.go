...
type RouterArgs struct {
	...
	NeedsActivationHost string
}

func MakeRouter(args *RouterArgs) (*servingv1alpha1.Service, error) {
	selectorJson, err := json.Marshal(args.Broker.Spec.Selector)
	if err != nil {
		return nil, err
	}
					...
					RevisionTemplate: servingv1alpha1.RevisionTemplateSpec{
						Spec: servingv1alpha1.RevisionSpec{
							...
							Container: v1.Container{
								...
								Env: []v1.EnvVar{
									{
										Name:  "NEEDS_ACTIVATION_HOST",
										Value: args.NeedsActivationHost,
									},
									{
										Name:  "LABEL_SELECTOR",
