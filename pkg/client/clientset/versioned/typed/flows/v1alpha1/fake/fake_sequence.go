...
var sequencesResource = schema.GroupVersionResource{Group: "flows.knative.dev", Version: "v1alpha1", Resource: "sequences"}

var sequencesKind = schema.GroupVersionKind{Group: "flows.knative.dev", Version: "v1alpha1", Kind: "Sequence"}
