...
type ParallelInterface interface {
	Create(*v1.Parallel) (*v1.Parallel, error)
	Update(*v1.Parallel) (*v1.Parallel, error)
	UpdateStatus(*v1.Parallel) (*v1.Parallel, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.Parallel, error)
	List(opts metav1.ListOptions) (*v1.ParallelList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Parallel, err error)
	ParallelExpansion
}
...
func (c *parallels) Get(name string, options metav1.GetOptions) (result *v1.Parallel, err error) {
	result = &v1.Parallel{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("parallels").
...
func (c *parallels) List(opts metav1.ListOptions) (result *v1.ParallelList, err error) {
...
func (c *parallels) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *parallels) Create(parallel *v1.Parallel) (result *v1.Parallel, err error) {
	result = &v1.Parallel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("parallels").
...
func (c *parallels) Update(parallel *v1.Parallel) (result *v1.Parallel, err error) {
	result = &v1.Parallel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("parallels").
...
func (c *parallels) UpdateStatus(parallel *v1.Parallel) (result *v1.Parallel, err error) {
	result = &v1.Parallel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("parallels").
...
func (c *parallels) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *parallels) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *parallels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Parallel, err error) {
	result = &v1.Parallel{}
