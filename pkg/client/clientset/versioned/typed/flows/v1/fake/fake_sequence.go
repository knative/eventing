...
func (c *FakeSequences) Get(name string, options v1.GetOptions) (result *flowsv1.Sequence, err error) {
	obj, err := c.Fake.
...
func (c *FakeSequences) List(opts v1.ListOptions) (result *flowsv1.SequenceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSequences) Create(sequence *flowsv1.Sequence) (result *flowsv1.Sequence, err error) {
	obj, err := c.Fake.
...
func (c *FakeSequences) Update(sequence *flowsv1.Sequence) (result *flowsv1.Sequence, err error) {
	obj, err := c.Fake.
...
func (c *FakeSequences) UpdateStatus(sequence *flowsv1.Sequence) (*flowsv1.Sequence, error) {
	obj, err := c.Fake.
...
func (c *FakeSequences) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *flowsv1.Sequence, err error) {
	obj, err := c.Fake.
