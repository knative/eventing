...
func (c *FakeParallels) Get(name string, options v1.GetOptions) (result *flowsv1.Parallel, err error) {
	obj, err := c.Fake.
...
func (c *FakeParallels) List(opts v1.ListOptions) (result *flowsv1.ParallelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeParallels) Create(parallel *flowsv1.Parallel) (result *flowsv1.Parallel, err error) {
	obj, err := c.Fake.
...
func (c *FakeParallels) Update(parallel *flowsv1.Parallel) (result *flowsv1.Parallel, err error) {
	obj, err := c.Fake.
...
func (c *FakeParallels) UpdateStatus(parallel *flowsv1.Parallel) (*flowsv1.Parallel, error) {
	obj, err := c.Fake.
...
func (c *FakeParallels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *flowsv1.Parallel, err error) {
	obj, err := c.Fake.
