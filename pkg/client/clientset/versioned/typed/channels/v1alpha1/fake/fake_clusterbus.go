...
func (c *FakeClusterBuses) Get(name string, options v1.GetOptions) (result *v1alpha1.ClusterBus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clusterbusesResource, name), &v1alpha1.ClusterBus{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterBus), err
}
...
func (c *FakeClusterBuses) List(opts v1.ListOptions) (result *v1alpha1.ClusterBusList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clusterbusesResource, clusterbusesKind, opts), &v1alpha1.ClusterBusList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterBuses) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(clusterbusesResource, opts))
}
...
func (c *FakeClusterBuses) Create(clusterBus *v1alpha1.ClusterBus) (result *v1alpha1.ClusterBus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clusterbusesResource, clusterBus), &v1alpha1.ClusterBus{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterBus), err
...
func (c *FakeClusterBuses) Update(clusterBus *v1alpha1.ClusterBus) (result *v1alpha1.ClusterBus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clusterbusesResource, clusterBus), &v1alpha1.ClusterBus{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterBus), err
...
func (c *FakeClusterBuses) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(clusterbusesResource, name), &v1alpha1.ClusterBus{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeClusterBuses) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(clusterbusesResource, listOptions)

	_, err := c.Fake.Invokes(action, &v1alpha1.ClusterBusList{})
	return err
}
...
func (c *FakeClusterBuses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.ClusterBus, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clusterbusesResource, name, data, subresources...), &v1alpha1.ClusterBus{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterBus), err
