...
func (c *pingSources) Get(name string, options v1.GetOptions) (result *v1alpha2.PingSource, err error) {
...
func (c *pingSources) List(opts v1.ListOptions) (result *v1alpha2.PingSourceList, err error) {
...
func (c *pingSources) Create(pingSource *v1alpha2.PingSource) (result *v1alpha2.PingSource, err error) {
	result = &v1alpha2.PingSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pingsources").
...
func (c *pingSources) Update(pingSource *v1alpha2.PingSource) (result *v1alpha2.PingSource, err error) {
	result = &v1alpha2.PingSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pingsources").
...
func (c *pingSources) UpdateStatus(pingSource *v1alpha2.PingSource) (result *v1alpha2.PingSource, err error) {
	result = &v1alpha2.PingSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pingsources").
...
func (c *pingSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.PingSource, err error) {
	result = &v1alpha2.PingSource{}
