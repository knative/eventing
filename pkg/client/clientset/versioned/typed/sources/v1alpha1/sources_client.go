...
func (c *SourcesV1alpha1Client) Binds(namespace string) BindInterface {
	return newBinds(c, namespace)
}

func (c *SourcesV1alpha1Client) EventSources(namespace string) EventSourceInterface {
	return newEventSources(c, namespace)
}

func (c *SourcesV1alpha1Client) EventTypes(namespace string) EventTypeInterface {
