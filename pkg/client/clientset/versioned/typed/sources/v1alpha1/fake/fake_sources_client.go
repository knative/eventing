...
func (c *FakeSourcesV1alpha1) Binds(namespace string) v1alpha1.BindInterface {
	return &FakeBinds{c, namespace}
}

func (c *FakeSourcesV1alpha1) EventSources(namespace string) v1alpha1.EventSourceInterface {
	return &FakeEventSources{c, namespace}
}

func (c *FakeSourcesV1alpha1) EventTypes(namespace string) v1alpha1.EventTypeInterface {
