...
type SinkBindingInterface interface {
	Create(*v1beta1.SinkBinding) (*v1beta1.SinkBinding, error)
	Update(*v1beta1.SinkBinding) (*v1beta1.SinkBinding, error)
	UpdateStatus(*v1beta1.SinkBinding) (*v1beta1.SinkBinding, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.SinkBinding, error)
	List(opts v1.ListOptions) (*v1beta1.SinkBindingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SinkBinding, err error)
...
func (c *sinkBindings) Get(name string, options v1.GetOptions) (result *v1beta1.SinkBinding, err error) {
...
func (c *sinkBindings) List(opts v1.ListOptions) (result *v1beta1.SinkBindingList, err error) {
...
func (c *sinkBindings) Create(sinkBinding *v1beta1.SinkBinding) (result *v1beta1.SinkBinding, err error) {
	result = &v1beta1.SinkBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sinkbindings").
...
func (c *sinkBindings) Update(sinkBinding *v1beta1.SinkBinding) (result *v1beta1.SinkBinding, err error) {
	result = &v1beta1.SinkBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sinkbindings").
...
func (c *sinkBindings) UpdateStatus(sinkBinding *v1beta1.SinkBinding) (result *v1beta1.SinkBinding, err error) {
	result = &v1beta1.SinkBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sinkbindings").
...
func (c *sinkBindings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SinkBinding, err error) {
	result = &v1beta1.SinkBinding{}
