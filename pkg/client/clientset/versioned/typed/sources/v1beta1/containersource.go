...
type ContainerSourceInterface interface {
	Create(*v1beta1.ContainerSource) (*v1beta1.ContainerSource, error)
	Update(*v1beta1.ContainerSource) (*v1beta1.ContainerSource, error)
	UpdateStatus(*v1beta1.ContainerSource) (*v1beta1.ContainerSource, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.ContainerSource, error)
	List(opts v1.ListOptions) (*v1beta1.ContainerSourceList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ContainerSource, err error)
...
func (c *containerSources) Get(name string, options v1.GetOptions) (result *v1beta1.ContainerSource, err error) {
...
func (c *containerSources) List(opts v1.ListOptions) (result *v1beta1.ContainerSourceList, err error) {
...
func (c *containerSources) Create(containerSource *v1beta1.ContainerSource) (result *v1beta1.ContainerSource, err error) {
	result = &v1beta1.ContainerSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("containersources").
...
func (c *containerSources) Update(containerSource *v1beta1.ContainerSource) (result *v1beta1.ContainerSource, err error) {
	result = &v1beta1.ContainerSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containersources").
...
func (c *containerSources) UpdateStatus(containerSource *v1beta1.ContainerSource) (result *v1beta1.ContainerSource, err error) {
	result = &v1beta1.ContainerSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("containersources").
...
func (c *containerSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ContainerSource, err error) {
	result = &v1beta1.ContainerSource{}
