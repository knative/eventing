...
func (c *FakeContainerSources) Get(name string, options v1.GetOptions) (result *v1beta1.ContainerSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeContainerSources) List(opts v1.ListOptions) (result *v1beta1.ContainerSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeContainerSources) Create(containerSource *v1beta1.ContainerSource) (result *v1beta1.ContainerSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeContainerSources) Update(containerSource *v1beta1.ContainerSource) (result *v1beta1.ContainerSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeContainerSources) UpdateStatus(containerSource *v1beta1.ContainerSource) (*v1beta1.ContainerSource, error) {
	obj, err := c.Fake.
...
func (c *FakeContainerSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ContainerSource, err error) {
	obj, err := c.Fake.
