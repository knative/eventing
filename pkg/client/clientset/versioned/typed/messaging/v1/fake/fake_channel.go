...
func (c *FakeChannels) Get(name string, options v1.GetOptions) (result *messagingv1.Channel, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) List(opts v1.ListOptions) (result *messagingv1.ChannelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) Create(channel *messagingv1.Channel) (result *messagingv1.Channel, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) Update(channel *messagingv1.Channel) (result *messagingv1.Channel, err error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) UpdateStatus(channel *messagingv1.Channel) (*messagingv1.Channel, error) {
	obj, err := c.Fake.
...
func (c *FakeChannels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *messagingv1.Channel, err error) {
	obj, err := c.Fake.
