...
func (c *FakeSubscriptions) Get(name string, options v1.GetOptions) (result *messagingv1.Subscription, err error) {
	obj, err := c.Fake.
...
func (c *FakeSubscriptions) List(opts v1.ListOptions) (result *messagingv1.SubscriptionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSubscriptions) Create(subscription *messagingv1.Subscription) (result *messagingv1.Subscription, err error) {
	obj, err := c.Fake.
...
func (c *FakeSubscriptions) Update(subscription *messagingv1.Subscription) (result *messagingv1.Subscription, err error) {
	obj, err := c.Fake.
...
func (c *FakeSubscriptions) UpdateStatus(subscription *messagingv1.Subscription) (*messagingv1.Subscription, error) {
	obj, err := c.Fake.
...
func (c *FakeSubscriptions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(subscriptionsResource, c.ns, name), &messagingv1.Subscription{})
...
func (c *FakeSubscriptions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *messagingv1.Subscription, err error) {
	obj, err := c.Fake.
