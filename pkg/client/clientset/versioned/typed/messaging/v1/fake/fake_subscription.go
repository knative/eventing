...
func (c *FakeSubscriptions) List(ctx context.Context, opts metav1.ListOptions) (result *v1.SubscriptionList, err error) {
	emptyResult := &v1.SubscriptionList{}
	obj, err := c.Fake.
...
func (c *FakeSubscriptions) UpdateStatus(ctx context.Context, subscription *v1.Subscription, opts metav1.UpdateOptions) (result *v1.Subscription, err error) {
	emptyResult := &v1.Subscription{}
	obj, err := c.Fake.
