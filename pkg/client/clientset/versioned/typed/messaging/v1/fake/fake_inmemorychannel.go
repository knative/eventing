...
func (c *FakeInMemoryChannels) Get(name string, options v1.GetOptions) (result *messagingv1.InMemoryChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakeInMemoryChannels) List(opts v1.ListOptions) (result *messagingv1.InMemoryChannelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeInMemoryChannels) Create(inMemoryChannel *messagingv1.InMemoryChannel) (result *messagingv1.InMemoryChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakeInMemoryChannels) Update(inMemoryChannel *messagingv1.InMemoryChannel) (result *messagingv1.InMemoryChannel, err error) {
	obj, err := c.Fake.
...
func (c *FakeInMemoryChannels) UpdateStatus(inMemoryChannel *messagingv1.InMemoryChannel) (*messagingv1.InMemoryChannel, error) {
	obj, err := c.Fake.
...
func (c *FakeInMemoryChannels) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *messagingv1.InMemoryChannel, err error) {
	obj, err := c.Fake.
