...
// EventingV1beta2Client is used to interact with features provided by the eventing.elafros.dev group.
type EventingV1beta2Client struct {
	restClient rest.Interface
}

func (c *EventingV1beta2Client) Flows(namespace string) FlowInterface {
