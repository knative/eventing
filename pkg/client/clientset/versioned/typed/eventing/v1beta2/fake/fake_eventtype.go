...
func (c *FakeEventTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.EventTypeList, err error) {
	emptyResult := &v1beta2.EventTypeList{}
	obj, err := c.Fake.
...
func (c *FakeEventTypes) UpdateStatus(ctx context.Context, eventType *v1beta2.EventType, opts v1.UpdateOptions) (result *v1beta2.EventType, err error) {
	emptyResult := &v1beta2.EventType{}
	obj, err := c.Fake.
