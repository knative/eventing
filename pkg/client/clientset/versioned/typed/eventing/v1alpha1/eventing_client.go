...
func (c *EventingV1alpha1Client) EventTypeDefinitions(namespace string) EventTypeDefinitionInterface {
	return newEventTypeDefinitions(c, namespace)
}
