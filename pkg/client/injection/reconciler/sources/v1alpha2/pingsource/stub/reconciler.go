...
import (
	...
	pingsource "knative.dev/eventing/pkg/client/injection/reconciler/sources/v1alpha2/pingsource"
...
//var _ pingsource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ pingsource.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha2.PingSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha2.PingSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha2.PingSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha2.PingSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
