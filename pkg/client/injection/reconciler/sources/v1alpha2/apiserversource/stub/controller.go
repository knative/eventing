...
import (
	...
	v1alpha2apiserversource "knative.dev/eventing/pkg/client/injection/reconciler/sources/v1alpha2/apiserversource"
...
func NewController(
	...
	r := &Reconciler{}
	impl := v1alpha2apiserversource.NewImpl(ctx, r)
