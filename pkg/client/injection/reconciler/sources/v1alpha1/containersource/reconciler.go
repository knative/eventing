...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.ContainerSources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.ContainerSource, desired *v1alpha1.ContainerSource) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.SourcesV1alpha1().ContainerSources(desired.Namespace)
		...
		updater := r.Client.SourcesV1alpha1().ContainerSources(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ContainerSource) (*v1alpha1.ContainerSource, error) {
	...
	patcher := r.Client.SourcesV1alpha1().ContainerSources(resource.Namespace)
