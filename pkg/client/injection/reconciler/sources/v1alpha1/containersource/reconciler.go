...
// controller finalizing v1alpha1.ContainerSource.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.ContainerSource. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.ContainerSource) reconciler.Event
}

// reconcilerImpl implements controller.Reconciler for v1alpha1.ContainerSource resources.
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister sourcesv1alpha1.ContainerSourceLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.ContainerSource, desired *v1alpha1.ContainerSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ContainerSource) (*v1alpha1.ContainerSource, error) {
	finalizerName := defaultFinalizerName

	actual, err := r.Lister.ContainerSources(resource.Namespace).Get(resource.Name)
	if err != nil {
		return resource, err
	}
	...
	resource, err = r.Client.SourcesV1alpha1().ContainerSources(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1alpha1.ContainerSource) (*v1alpha1.ContainerSource, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.ContainerSource, reconcileEvent reconciler.Event) (*v1alpha1.ContainerSource, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
