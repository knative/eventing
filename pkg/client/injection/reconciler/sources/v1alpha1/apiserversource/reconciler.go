...
// Reconciler implements controller.Reconciler for v1alpha1.ApiServerSource resources.
type Core struct {
...
func (r *Core) updateStatus(existing *v1alpha1.ApiServerSource, desired *v1alpha1.ApiServerSource) error {
...
func (r *Core) updateFinalizers(ctx context.Context, desired *v1alpha1.ApiServerSource) (*v1alpha1.ApiServerSource, bool, error) {
	actual, err := r.Lister.ApiServerSources(desired.Namespace).Get(desired.Name)
	if err != nil {
	...
	update, err := r.Client.SourcesV1alpha1().ApiServerSources(desired.Namespace).Patch(existing.Name, types.MergePatchType, patch)
	return update, true, err
}

func (r *Core) setFinalizer(a *v1alpha1.ApiServerSource) {
	finalizers := sets.NewString(a.Finalizers...)
	finalizers.Insert(r.FinalizerName)
	a.Finalizers = finalizers.List()
}

func (r *Core) unsetFinalizer(a *v1alpha1.ApiServerSource) {
	finalizers := sets.NewString(a.Finalizers...)
