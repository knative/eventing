...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ApiServerSource) (*v1alpha1.ApiServerSource, error) {
	...
	resource, err = r.Client.SourcesV1alpha1().ApiServerSources(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.ApiServerSource, reconcileEvent reconciler.Event) (reconciler.Event, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
