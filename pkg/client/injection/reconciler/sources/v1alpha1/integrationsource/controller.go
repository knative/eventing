...
import (
	...
	integrationsource "knative.dev/eventing/pkg/client/injection/informers/sources/v1alpha1/integrationsource"
...
const (
	defaultControllerAgentName = "integrationsource-controller"
	defaultFinalizerName       = "integrationsources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	integrationsourceInformer := integrationsource.Get(ctx)

	lister := integrationsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.IntegrationSource"),
	)
