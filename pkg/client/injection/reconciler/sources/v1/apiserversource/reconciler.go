...
// controller finalizing v1.ApiServerSource if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1.ApiServerSource.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1.ApiServerSource) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1.ApiServerSource, desired *v1.ApiServerSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.ApiServerSource) (*v1.ApiServerSource, error) {
