...
// controller finalizing v1.PingSource if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1.PingSource.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1.PingSource) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1.PingSource, desired *v1.PingSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.PingSource) (*v1.PingSource, error) {
