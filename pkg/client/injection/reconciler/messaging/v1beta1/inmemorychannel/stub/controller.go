...
import (
	...
	v1beta1inmemorychannel "knative.dev/eventing/pkg/client/injection/reconciler/messaging/v1beta1/inmemorychannel"
...
func NewController(
	...
	r := &Reconciler{}
	impl := v1beta1inmemorychannel.NewImpl(ctx, r)
