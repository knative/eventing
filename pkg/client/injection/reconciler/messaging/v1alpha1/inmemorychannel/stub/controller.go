...
import (
	...
	v1alpha1inmemorychannel "knative.dev/eventing/pkg/client/injection/reconciler/messaging/v1alpha1/inmemorychannel"
...
// NewController creates a Reconciler for InMemoryChannel and returns the result of NewImpl.
func NewController(
	ctx context.Context,
	...
	r := &Reconciler{}
	impl := v1alpha1inmemorychannel.NewImpl(ctx, r)
