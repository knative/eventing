...
import (
	...
	inmemorychannel "knative.dev/eventing/pkg/client/injection/reconciler/messaging/v1/inmemorychannel"
...
//var _ inmemorychannel.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ inmemorychannel.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *messagingv1.InMemoryChannel) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *messagingv1.InMemoryChannel) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *messagingv1.InMemoryChannel) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *messagingv1.InMemoryChannel) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
