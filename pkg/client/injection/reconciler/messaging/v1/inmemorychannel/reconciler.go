...
// controller finalizing v1.InMemoryChannel if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1.InMemoryChannel.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1.InMemoryChannel) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(existing *v1.InMemoryChannel, desired *v1.InMemoryChannel) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.InMemoryChannel) (*v1.InMemoryChannel, error) {
