...
// controller finalizing v1.Subscription if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1.Subscription.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1.Subscription) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(existing *v1.Subscription, desired *v1.Subscription) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Subscription) (*v1.Subscription, error) {
