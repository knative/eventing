...
import (
	...
	jobsink "knative.dev/eventing/pkg/client/injection/informers/sinks/v1alpha1/jobsink"
...
const (
	defaultControllerAgentName = "jobsink-controller"
	defaultFinalizerName       = "jobsinks.sinks.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sinks.knative.dev.JobSink"),
	)
