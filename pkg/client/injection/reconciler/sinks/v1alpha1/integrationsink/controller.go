...
import (
	...
	integrationsink "knative.dev/eventing/pkg/client/injection/informers/sinks/v1alpha1/integrationsink"
...
const (
	defaultControllerAgentName = "integrationsink-controller"
	defaultFinalizerName       = "integrationsinks.sinks.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := integrationsinkInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sinks.knative.dev.IntegrationSink"),
	)
