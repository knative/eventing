...
const (
	defaultControllerAgentName = "configmappropagation-controller"
	defaultFinalizerName       = "configmappropagations.configs.internal.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := configmappropagationInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "configs.internal.knative.dev.ConfigMapPropagation"),
	)
