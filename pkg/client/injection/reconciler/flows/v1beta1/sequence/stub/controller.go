...
import (
	...
	v1beta1sequence "knative.dev/eventing/pkg/client/injection/reconciler/flows/v1beta1/sequence"
...
// NewController creates a Reconciler for Sequence and returns the result of NewImpl.
func NewController(
	ctx context.Context,
	...
	r := &Reconciler{}
	impl := v1beta1sequence.NewImpl(ctx, r)
