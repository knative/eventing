...
import (
	...
	v1beta1parallel "knative.dev/eventing/pkg/client/injection/reconciler/flows/v1beta1/parallel"
...
// NewController creates a Reconciler for Parallel and returns the result of NewImpl.
func NewController(
	ctx context.Context,
	...
	r := &Reconciler{}
	impl := v1beta1parallel.NewImpl(ctx, r)
