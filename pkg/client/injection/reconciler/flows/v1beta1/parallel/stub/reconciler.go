...
import (
	...
	parallel "knative.dev/eventing/pkg/client/injection/reconciler/flows/v1beta1/parallel"
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "ParallelReconciled", "Parallel reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for Parallel resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ parallel.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ parallel.Finalizer = (*Reconciler)(nil)
...
//var _ parallel.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ parallel.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1beta1.Parallel) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1beta1.Parallel) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1beta1.Parallel) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1beta1.Parallel) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
