...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.Sequences(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.Sequence, desired *v1alpha1.Sequence) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.FlowsV1alpha1().Sequences(desired.Namespace)
		...
		updater := r.Client.FlowsV1alpha1().Sequences(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.Sequence) (*v1alpha1.Sequence, error) {
	...
	patcher := r.Client.FlowsV1alpha1().Sequences(resource.Namespace)
