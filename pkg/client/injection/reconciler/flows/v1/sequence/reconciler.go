...
// controller finalizing v1.Sequence if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1.Sequence.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1.Sequence) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(existing *v1.Sequence, desired *v1.Sequence) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Sequence) (*v1.Sequence, error) {
