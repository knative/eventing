...
import (
	...
	sequence "knative.dev/eventing/pkg/client/injection/reconciler/flows/v1/sequence"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *flowsv1.Sequence) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *flowsv1.Sequence) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *flowsv1.Sequence) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *flowsv1.Sequence) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
