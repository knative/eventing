...
// controller finalizing v1.Parallel if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1.Parallel.
	// This method should not write to the API.
	//
	// Deprecated: Use reconciler.ObserveDeletion instead.
	ObserveFinalizeKind(ctx context.Context, o *v1.Parallel) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1.Parallel, desired *v1.Parallel) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1.Parallel) (*v1.Parallel, error) {
