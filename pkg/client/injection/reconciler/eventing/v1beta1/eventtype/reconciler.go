...
// controller finalizing v1beta1.EventType if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1beta1.EventType.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1beta1.EventType) reconciler.Event
}
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.EventType, desired *v1beta1.EventType) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.EventType) (*v1beta1.EventType, error) {
