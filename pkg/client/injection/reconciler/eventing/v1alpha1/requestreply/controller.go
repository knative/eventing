...
import (
	...
	requestreply "knative.dev/eventing/pkg/client/injection/informers/eventing/v1alpha1/requestreply"
...
const (
	defaultControllerAgentName = "requestreply-controller"
	defaultFinalizerName       = "requestreplies.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := requestreplyInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.knative.dev.RequestReply"),
	)
