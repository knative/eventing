...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.EventTypes(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.EventType, desired *v1alpha1.EventType) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.EventingV1alpha1().EventTypes(desired.Namespace)
		...
		updater := r.Client.EventingV1alpha1().EventTypes(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.EventType) (*v1alpha1.EventType, error) {
	...
	patcher := r.Client.EventingV1alpha1().EventTypes(resource.Namespace)
