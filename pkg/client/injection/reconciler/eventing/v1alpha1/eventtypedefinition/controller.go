...
import (
	...
	eventtypedefinition "knative.dev/eventing/pkg/client/injection/informers/eventing/v1alpha1/eventtypedefinition"
...
const (
	defaultControllerAgentName = "eventtypedefinition-controller"
	defaultFinalizerName       = "eventtypedefinitions.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	eventtypedefinitionInformer := eventtypedefinition.Get(ctx)

	lister := eventtypedefinitionInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.knative.dev.EventTypeDefinition"),
	)
