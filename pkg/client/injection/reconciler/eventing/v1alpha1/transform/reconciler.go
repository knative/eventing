...
type reconcilerImpl struct {
	...
	Lister eventingv1alpha1.TransformLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister eventingv1alpha1.TransformLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.Transforms(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.EventTransform, desired *v1alpha1.EventTransform) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.EventingV1alpha1().Transforms(desired.Namespace)
		...
		updater := r.Client.EventingV1alpha1().Transforms(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.EventTransform, desiredFinalizers sets.Set[string]) (*v1alpha1.EventTransform, error) {
	...
	patcher := r.Client.EventingV1alpha1().Transforms(resource.Namespace)
