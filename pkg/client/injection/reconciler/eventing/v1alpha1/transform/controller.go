...
import (
	...
	transform "knative.dev/eventing/pkg/client/injection/informers/eventing/v1alpha1/transform"
...
const (
	defaultControllerAgentName = "transform-controller"
	defaultFinalizerName       = "transforms.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	transformInformer := transform.Get(ctx)

	lister := transformInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "eventing.knative.dev.Transform"),
	)
