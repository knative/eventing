...
import (
	...
	broker "knative.dev/eventing/pkg/client/injection/reconciler/eventing/v1alpha1/broker"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.Broker) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.Broker) reconciler.Event {
