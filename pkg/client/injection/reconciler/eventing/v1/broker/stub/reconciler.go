...
import (
	...
	broker "knative.dev/eventing/pkg/client/injection/reconciler/eventing/v1/broker"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *eventingv1.Broker) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *eventingv1.Broker) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *eventingv1.Broker) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *eventingv1.Broker) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
