	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SourcesV1alpha1().Binds(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SourcesV1alpha1().Binds(namespace).Watch(options)
			},
		},
		&sources_v1alpha1.Bind{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bindInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sources_v1alpha1.Bind{}, f.defaultInformer)
}
