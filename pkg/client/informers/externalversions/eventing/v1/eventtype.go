	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EventingV1().EventTypes(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventingV1().EventTypes(namespace).Watch(options)
			},
		},
		&eventingv1.EventType{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *eventTypeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eventingv1.EventType{}, f.defaultInformer)
}

func (f *eventTypeInformer) Lister() v1.EventTypeLister {
	return v1.NewEventTypeLister(f.Informer().GetIndexer())
}
