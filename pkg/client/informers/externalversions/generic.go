...
<<<<<<< HEAD
	case eventing_v1alpha1.SchemeGroupVersion.WithResource("provisioners"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Eventing().V1alpha1().Provisioners().Informer()}, nil
