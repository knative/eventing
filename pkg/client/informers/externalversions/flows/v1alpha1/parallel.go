	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FlowsV1alpha1().Parallels(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FlowsV1alpha1().Parallels(namespace).Watch(options)
			},
		},
		&flowsv1alpha1.Parallel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *parallelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flowsv1alpha1.Parallel{}, f.defaultInformer)
}
