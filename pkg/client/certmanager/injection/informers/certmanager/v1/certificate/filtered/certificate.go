...
func Get(ctx context.Context, selector string) v1.CertificateInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch knative.dev/eventing/pkg/client/certmanager/informers/externalversions/certmanager/v1.CertificateInformer with selector %s from context.", selector)
	}
