...
const (
	importerResourceGroupValue = "cronjobsources.sources.eventing.knative.dev"
)
...
// NewStatsReporter creates a reporter that collects and reports cronjobsource
// metrics.
func NewStatsReporter() (StatsReporter, error) {
	...
	err = view.Register(
		&view.View{
			...
			TagKeys:     []tag.Key{r.namespaceTagKey, r.eventTypeTagKey, r.eventSourceTagKey, r.importerNameTagKey, r.importerResourceGroupTagKey, r.responseCodeKey, r.responseCodeClassKey},
		},
	)
	if err != nil {
		return nil, err
