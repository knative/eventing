...
func TestUpdateRemoveAdapter(t *testing.T) {
	...
	adapter.Update(ctx, &sourcesv1beta2.PingSource{
	...
	adapter.Remove(ctx, &sourcesv1beta2.PingSource{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "test-name",
			Namespace: "test-ns",
		},
...
func (*testRunner) AddSchedule(*sourcesv1beta2.PingSource) cron.EntryID {
