...
func TestFanoutHandlerBinding_ServeHTTP(t *testing.T) {
	testCases := map[string]struct {
		receiverFunc   channel.ReceiverBindingsFunc
	...
	for n, tc := range testCases {
		t.Run(n, func(t *testing.T) {
			...
			h, err := NewHandlerBinding(context.TODO(), zap.NewNop(), Config{Subscriptions: subs})
			if err != nil {
			...
			if tc.receiverFunc != nil {
				receiver, err := channel.NewEventReceiverBinding(context.TODO(), tc.receiverFunc, zap.NewNop())
				if err != nil {
