	...
	table := TableTest{
		{
			...
			Objects: []runtime.Object{
				...
				NewMessagingChannel(channelName, testNS,
					...
					WithMessagingChannelAddress(channelDNS),
				),
			...
			Objects: []runtime.Object{
				...
				NewCustomResourceDefinition("channels.messaging.knative.dev",
					WithCustomResourceDefinitionLabels(map[string]string{channelCrdLabelKey: channelCrdLabelValue})),
			},
			Key:     testNS + "/" + subscriptionName,
			WantErr: true,
			WantEvents: []string{
			...
			Objects: []runtime.Object{
				...
				NewMessagingChannel(channelName, testNS,
					WithInitMessagingChannelConditions,
					WithMessagingChannelAddress(channelDNS),
					WithMessagingChannelReadySubscriber(subscriptionUID),
				),
				NewCustomResourceDefinition("channels.messaging.knative.dev",
					WithCustomResourceDefinitionLabels(map[string]string{channelCrdLabelKey: channelCrdLabelValue})),
			},
			...
			Objects: []runtime.Object{
				...
				NewMessagingChannel(replyName, testNS,
					WithInitMessagingChannelConditions,
					WithMessagingChannelAddress(replyDNS),
				),
				NewCustomResourceDefinition("channels.messaging.knative.dev",
					WithCustomResourceDefinitionLabels(map[string]string{channelCrdLabelKey: channelCrdLabelValue})),
			},
			...
			Objects: []runtime.Object{
				...
				NewMessagingChannel(channelName, testNS,
					WithInitMessagingChannelConditions,
					WithMessagingChannelAddress(channelDNS),
					WithMessagingChannelSubscribers([]eventingduck.SubscriberSpec{
						{UID: subscriptionUID, SubscriberURI: subscriberURI, ReplyURI: replyURI, DeprecatedRef: &corev1.ObjectReference{Name: subscriptionName, Namespace: testNS, UID: subscriptionUID}},
					}),
					WithMessagingChannelReadySubscriberAndGeneration(subscriptionUID, subscriptionGeneration),
				),
				NewCustomResourceDefinition("channels.messaging.knative.dev",
					WithCustomResourceDefinitionLabels(map[string]string{channelCrdLabelKey: channelCrdLabelValue})),
			},
			...
			Objects: []runtime.Object{
				...
				NewMessagingChannel(channelName, testNS,
					WithInitMessagingChannelConditions,
					WithMessagingChannelAddress(channelDNS),
					WithMessagingChannelReadySubscriber("a_"+subscriptionUID),
					WithMessagingChannelReadySubscriber("b_"+subscriptionUID),
				),
				NewCustomResourceDefinition("channels.messaging.knative.dev",
					WithCustomResourceDefinitionLabels(map[string]string{channelCrdLabelKey: channelCrdLabelValue})),
				NewService(serviceName, testNS),
