...
func WithTriggerChannelReady() BrokerOption {
	return func(b *v1beta1.Broker) {
		b.Status.PropagateTriggerChannelReadiness(v1beta1.TestHelper.ReadyChannelStatus())
	}
}

func WithFilterAvailable() BrokerOption {
	return func(b *v1beta1.Broker) {
		b.Status.PropagateFilterAvailability(v1beta1.TestHelper.AvailableEndpoints())
	}
}

func WithIngressAvailable() BrokerOption {
	return func(b *v1beta1.Broker) {
		b.Status.PropagateIngressAvailability(v1beta1.TestHelper.AvailableEndpoints())
	}
}
