	...
	table := TableTest{
		{
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewFlowsParallel(parallelName, testNS,
					...
					WithFlowsParallelIngressChannelStatus(createParallelChannelStatus(parallelName, corev1.ConditionUnknown)),
					WithFlowsParallelBranchStatuses([]v1.ParallelBranchStatus{{
						FilterSubscriptionStatus: createParallelFilterSubscriptionStatus(parallelName, 0, corev1.ConditionUnknown),
						FilterChannelStatus:      createParallelBranchChannelStatus(parallelName, 0, corev1.ConditionUnknown),
						SubscriptionStatus:       createParallelSubscriptionStatus(parallelName, 0, corev1.ConditionUnknown),
					}})),
			}},
		}, {
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewFlowsParallel(parallelName, testNS,
					...
					WithFlowsParallelBranchStatuses([]v1.ParallelBranchStatus{
						...
						{
							FilterSubscriptionStatus: createParallelFilterSubscriptionStatus(parallelName, 1, corev1.ConditionUnknown),
							FilterChannelStatus:      createParallelBranchChannelStatus(parallelName, 1, corev1.ConditionUnknown),
							SubscriptionStatus:       createParallelSubscriptionStatus(parallelName, 1, corev1.ConditionUnknown),
						}})),
			}},
		}, {
