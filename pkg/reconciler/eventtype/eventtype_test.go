		...
		},
		{
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewEventType(eventTypeName, testNS,
					...
					WithEventTypeBrokerFailed("BrokerFalse", "The status of Broker is False: inducing failure for create deployments"),
				),
			}},
		},
		{
			...
			WantStatusUpdates: []clientgotesting.UpdateActionImpl{{
				Object: NewEventType(eventTypeName, testNS,
					...
					WithEventTypeBroker(eventTypeBroker),
					WithEventTypeBrokerExists,
					WithEventTypeBrokerUnknown("BrokerUnknown", "The status of Broker is Unknown: "),
				),
			}},
		},
		{
