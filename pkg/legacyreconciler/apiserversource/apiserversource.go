...
import (
	"context"
	"fmt"
	"knative.dev/eventing/pkg/legacyreconciler/apiserversource/resources"
	"reflect"
	"time"
	...
	depv1alpha1 "knative.dev/eventing/pkg/apis/legacysources/v1alpha1"
...
func (r *Reconciler) reconcile(ctx context.Context, source *depv1alpha1.ApiServerSource) error {
...
func (r *Reconciler) createReceiveAdapter(ctx context.Context, src *depv1alpha1.ApiServerSource, sinkURI string) (*appsv1.Deployment, error) {
	// TODO: missing.
...
func (r *Reconciler) reconcileEventTypes(ctx context.Context, src *depv1alpha1.ApiServerSource) error {
...
func (r *Reconciler) getEventTypes(ctx context.Context, src *depv1alpha1.ApiServerSource) ([]eventingv1alpha1.EventType, error) {
...
func (r *Reconciler) makeEventTypes(src *depv1alpha1.ApiServerSource) ([]eventingv1alpha1.EventType, error) {
	eventTypes := make([]eventingv1alpha1.EventType, 0)
...
func (r *Reconciler) getLabelSelector(src *depv1alpha1.ApiServerSource) labels.Selector {
	return labels.SelectorFromSet(resources.Labels(src.Name))
}

func (r *Reconciler) updateStatus(ctx context.Context, desired *depv1alpha1.ApiServerSource) (*depv1alpha1.ApiServerSource, error) {
...
func (r *Reconciler) runAccessCheck(src *depv1alpha1.ApiServerSource) error {
