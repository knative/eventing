...
func (v *OIDCTokenVerifier) initOIDCProvider(ctx context.Context, features feature.Flags) error {
...
func (v *OIDCTokenVerifier) getKubernetesOIDCDiscovery(features feature.Flags) (*openIDMetadata, error) {
