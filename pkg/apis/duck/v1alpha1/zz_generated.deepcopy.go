...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeliverStatus) DeepCopyInto(out *DeliverStatus) {
	*out = *in
	if in.ErrorChannel != nil {
		in, out := &in.ErrorChannel, &out.ErrorChannel
		*out = new(v1.ObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeliverStatus.
func (in *DeliverStatus) DeepCopy() *DeliverStatus {
	if in == nil {
		return nil
	}
	out := new(DeliverStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DeliverySpec) DeepCopyInto(out *DeliverySpec) {
	*out = *in
	if in.ErrorSink != nil {
		in, out := &in.ErrorSink, &out.ErrorSink
