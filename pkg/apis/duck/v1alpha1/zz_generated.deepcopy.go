...
>>>>>>> 2213e00268f2ff7605ef1e485c6ef1a6413931bd
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
<<<<<<< HEAD
func (in *ChannelSubscriberStatus) DeepCopyInto(out *ChannelSubscriberStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChannelSubscriberStatus.
func (in *ChannelSubscriberStatus) DeepCopy() *ChannelSubscriberStatus {
	if in == nil {
		return nil
	}
	out := new(ChannelSubscriberStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SubscribableStatus) DeepCopyInto(out *SubscribableStatus) {
	*out = *in
	if in.Subscribers != nil {
		in, out := &in.Subscribers, &out.Subscribers
		*out = make([]ChannelSubscriberStatus, len(*in))
		copy(*out, *in)
	}
	return
}
