...
func (in *EventTypeSpec) DeepCopyInto(out *EventTypeSpec) {
	*out = *in
	...
	if in.Variables != nil {
		...
		*out = make([]EventVariableDefinition, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventVariableDefinition) DeepCopyInto(out *EventVariableDefinition) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventVariableDefinition.
func (in *EventVariableDefinition) DeepCopy() *EventVariableDefinition {
	if in == nil {
		return nil
	}
	out := new(EventVariableDefinition)
	in.DeepCopyInto(out)
	return out
}
