...
func (in *BrokerSpec) DeepCopyInto(out *BrokerSpec) {
	*out = *in
	...
	if in.SubscribableResources != nil {
		in, out := &in.SubscribableResources, &out.SubscribableResources
...
func (in *TriggerSelectorSpec) DeepCopyInto(out *TriggerSelectorSpec) {
	*out = *in
	...
	if in.HeaderExpression != nil {
		in, out := &in.HeaderExpression, &out.HeaderExpression
