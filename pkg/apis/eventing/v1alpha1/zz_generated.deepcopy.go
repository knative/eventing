...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterSelector) DeepCopyInto(out *FilterSelector) {
	*out = *in
	...
	if in.AttributeExpressions != nil {
		in, out := &in.AttributeExpressions, &out.AttributeExpressions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterSelector.
func (in *FilterSelector) DeepCopy() *FilterSelector {
	if in == nil {
		return nil
	}
	out := new(FilterSelector)
	in.DeepCopyInto(out)
	return out
}
