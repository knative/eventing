...
func TestChannelValidation(t *testing.T) {
	tests := []CRDTest{{
		...
		want: func() *apis.FieldError {
			fe := apis.ErrMissingField("spec.subscribable.subscriber[1].callableURI", "spec.subscribable.subscriber[1].sinkableURI")
		...
		want: func() *apis.FieldError {
			...
			fe := apis.ErrMissingField("spec.subscribable.subscriber[0].callableURI", "spec.subscribable.subscriber[0].sinkableURI")
			fe.Details = "expected at least one of, got none"
			errs = errs.Also(fe)
			fe = apis.ErrMissingField("spec.subscribable.subscriber[1].callableURI", "spec.subscribable.subscriber[1].sinkableURI")
			fe.Details = "expected at least one of, got none"
