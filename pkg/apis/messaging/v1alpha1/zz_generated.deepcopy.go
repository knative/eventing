...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParallelCase) DeepCopyInto(out *ParallelCase) {
	*out = *in
	if in.Filter != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParallelCase.
func (in *ParallelCase) DeepCopy() *ParallelCase {
	if in == nil {
		return nil
	}
	out := new(ParallelCase)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParallelCaseStatus) DeepCopyInto(out *ParallelCaseStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParallelCaseStatus.
func (in *ParallelCaseStatus) DeepCopy() *ParallelCaseStatus {
	if in == nil {
		return nil
	}
	out := new(ParallelCaseStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ParallelStatus) DeepCopyInto(out *ParallelStatus) {
	*out = *in
	...
	if in.CaseStatuses != nil {
		...
		*out = make([]ParallelCaseStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
