...
func (source *Sequence) ConvertUp(ctx context.Context, obj apis.Convertible) error {
...
func (sink *Sequence) ConvertDown(ctx context.Context, obj apis.Convertible) error {
