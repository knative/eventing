...
func TestParallelPropagateSubscriptionStatuses(t *testing.T) {
	tests := []struct {
		name  string
		fsubs []*messagingv1alpha1.Subscription
		...
		fsubs: []*messagingv1alpha1.Subscription{getSubscription("fsub0", false)},
		subs:  []*messagingv1alpha1.Subscription{getSubscription("sub0", false)},
		want:  corev1.ConditionFalse,
	}, {
		name:  "one filter and one subscription ready",
		fsubs: []*messagingv1alpha1.Subscription{getSubscription("fsub0", true)},
		subs:  []*messagingv1alpha1.Subscription{getSubscription("sub0", true)},
		...
		fsubs: []*messagingv1alpha1.Subscription{getSubscription("fsub0", true), getSubscription("fsub1", false)},
		subs:  []*messagingv1alpha1.Subscription{getSubscription("sub0", true), getSubscription("sub1", false)},
		want:  corev1.ConditionFalse,
	}, {
		name:  "two subscriptions ready",
		fsubs: []*messagingv1alpha1.Subscription{getSubscription("fsub0", true), getSubscription("fsub1", true)},
		subs:  []*messagingv1alpha1.Subscription{getSubscription("sub0", true), getSubscription("sub1", true)},
		want:  corev1.ConditionTrue,
	}}
