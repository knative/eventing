...
As described in the [source specification](https://github.com/knative/specs/specs/eventing/sources.md), a source is
...
[SinkBinding runtime contract](https://github.com/knative/specs/specs/eventing/sources.md#sinkbinding).
