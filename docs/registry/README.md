...
1.  An `Event Consumer` checks the Registry to see what EventTypes it can
...
1.  The `Event Consumer` creates a Trigger to listen to an EventType in the
    Registry.
...
- Does a user need to know which type of environment they're in before they
