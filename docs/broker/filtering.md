...
spec:
  filter:
    expression: >
      ce.type == "com.github.pull.create" && ce.source ==
      "https://github.com/knative/eventing/pulls/123"
```
...
spec:
  filter:
    expression: >
      ce.type == "com.github.pull.create" || (ce.type ==
      "com.github.issue.create" && ce.source.matches("proposals")
```
...
spec:
  filter:
    expression: >
      ce.type == "com.github.issue.create" && ce.repository == "proposals"
```
...
spec:
  filter:
    expression: >
      ce.type == "dev.knative.observation" && data.latency > 300.0
```
