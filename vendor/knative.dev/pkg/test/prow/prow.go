...
import "knative.dev/pkg/test/ci"

const (
	// ArtifactsDir is the dir containing artifacts
	//
	// Deprecated: use knative.dev/pkg/test/ci.ArtifactsDir
	ArtifactsDir = ci.ArtifactsDir
)

var (
	// IsCI returns whether the current environment is a CI environment.
	//
	// Deprecated: use knative.dev/pkg/test/ci.IsCI
	IsCI = ci.IsCI
	...
	//
	// Deprecated: use knative.dev/pkg/test/ci.GetLocalArtifactsDir
	GetLocalArtifactsDir = ci.GetLocalArtifactsDir
)
