	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DuckV1alpha1().Subscriptions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DuckV1alpha1().Subscriptions(namespace).Watch(options)
			},
		},
		&duckv1alpha1.Subscription{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *subscriptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&duckv1alpha1.Subscription{}, f.defaultInformer)
}
