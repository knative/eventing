...
import (
	...
	v1alpha1 "github.com/knative/eventing/pkg/client/listers/messaging/v1alpha1"
...
type InMemoryChannelInformer interface {
	...
	Lister() v1alpha1.InMemoryChannelLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MessagingV1alpha1().InMemoryChannels(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MessagingV1alpha1().InMemoryChannels(namespace).Watch(options)
			},
		},
		&messagingv1alpha1.InMemoryChannel{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inMemoryChannelInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&messagingv1alpha1.InMemoryChannel{}, f.defaultInformer)
}

func (f *inMemoryChannelInformer) Lister() v1alpha1.InMemoryChannelLister {
	return v1alpha1.NewInMemoryChannelLister(f.Informer().GetIndexer())
}
